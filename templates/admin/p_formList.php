<script type="text/javascript">
	$(document).ready( function() {
		...
		$('A[rel="details_form"]').live("click", function() {
		    $("#test-list").sortable({
			handle : '.handle',
			update : function () {
					...
					$.ajax({
						type: "POST",
						data: dataString,
						url: "<?php echo $tffPatch; ?>fieldsSortJS.html"
					});
			}
		    });
			...
			if(!arrive) {
				$.ajax({  
				  ...
				  success: function(transport) {
						tr.after(transport);
						this_a.find("img").attr("src","<?php echo $wwwPatch; ?>images/admin/icons/inpand.png");
						
						
					}
				})
			} else {
				tr.find('A[rel="details_form"]').find("img").attr("src","<?php echo $wwwPatch; ?>images/admin/icons/expand.png");
				$("#arrive"+id).remove();
			}
		...
		<table class="table-long" style="width: 990px;">
			<thead>
				<tr>
					...
					<td class="header" style="text-align: center">Rozwiń</td>
				</tr>
			</thead>
   			...
   			<tbody>
				<tr class="<?php echo $class; ?>">
	   				...
	   				<td style="text-align: center; width: 90px;">
	   					<a href="javascript:void(0);" rel="edit_form" title="Edytuj"><img src="<?php echo $wwwPatch; ?>images/admin/icons/edit.png" id="<?php echo $form['id_formularza']; ?>" alt="Edytuj" style="border: 0;" /></a>
	   				...
	   				<td style="text-align: center;"><a style="color: #6C7275; text-decoration: none;" href="javascript:void(0);" rel="details_form" id="<?php echo $form['id_formularza']; ?>" title="Rozwiń formularz"><img src="<?php echo $wwwPatch; ?>images/admin/icons/expand.png" alt="" /></a></td>
   				</tr>
   			</tbody>
