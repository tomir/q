...
<div id="distance"></div>
<div id="container">
	<div id="top"><img style="border: 0;" alt="tForm.net" src="../images/admin/logo_tff.png"></div>
	<div id="form-container">
		<?php if($komunikat) { ?>
			...
			<br style="clear: both" />
		<?php } ?>
		<form method="post" id="login-form" action="<?php echo $panelPatch; ?>zaloguj.html">
			<fieldset>
				...
				<ol>
					...
					<li><div class="align-right" style="margin-left: 468px;">
						<input type="image" src="../images/admin/bt-login.gif" name="zaloguj"/>
					</div></li>
				</ol>
			</fieldset>
		</form>
