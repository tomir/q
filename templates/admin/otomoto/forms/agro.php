		...
		<tr>
			...
			<td colspan="4">
				<select name="formData[type]" class="car_type">
					...
					<option value="AGRO" selected="selected">Maszyny rolnicze</option>
				</select>
			</td>
		</tr>
	</table>
		...
		<tbody>
				...
				<td style="border-top: 0;">
					<table style="width: 720px; margin-bottom: 15px;">
						...
						<tr>
							...
							<td>
								<input type="text" name="formData[make-name]" style="width: 100px;" value="" />
							</td>
							...
							<td>
								<input type="text" name="formData[model-name]" style="width: 100px;" value="<?php if(!isset($aData['model-name'])) echo $aCar['car_model']; else echo $aData['model-name']; ?>" />
							</td>
							<td style="vertical-align: middle; font-size: 12px; padding: 5px 8px; text-align: right; width: 150px;">
						...
						<tr>
							...
							<td>
								<select size="15" style="width: 220px;" name="formData[allegro-cat-id]" class="allegro_id">
									...
									<?php foreach($aAddsAgro['allegro'] as $row_al) { ?>
						...
						<tr>
							...
							<td>
								<select style="width: 100px;" name="formData[vehicle-category-key]" class="vehicle-category-key2">
									<option value="0">-- wybierz --</option>
									<?php foreach($aAddsAgro['body'] as $row_bo) { ?>
							...
							<td>
								<select style="width: 100px;" name="formData[vehicle-type]" class="vehicle-type2">
									<option value="0">-- wybierz --</option>
							...
							<td style="vertical-align: middle; font-size: 12px; padding: 5px 8px; text-align: right; width: 150px;">
								<span style="color: red; font-weight: bold;">Podtyp</span>:
							</td>
							<td>
								<select style="width: 100px;" name="formData[vehicle-subtype1]" class="vehicle-subtype1">
									<option value="0">-- wybierz --</option>
						...
						<tr>	
							<td style="vertical-align: middle; font-size: 12px; padding: 5px 8px; text-align: right; width: 150px;">
								<span style="color: red; font-weight: bold;">Podtyp 2</span>:
							</td>
							<td>
								<select style="width: 100px;" name="formData[vehicle-subtype2]" class="vehicle-subtype2">
									<option value="0">-- wybierz --</option>
									
								</select>
							</td>
							<td style="vertical-align: middle; font-size: 12px; padding: 5px 8px; text-align: right; width: 150px;">
								<span style="color: red; font-weight: bold;">Podtyp 3</span>:
							</td>
							<td>
								<select style="width: 100px;" name="formData[vehicle-subtype3]" class="vehicle-subtype3">
									<option value="0">-- wybierz --</option>
							...
							<td>
								<select name="formData[fuel-type-key]">
									<option value="0">-- wybierz --</option>
									<?php foreach($aAddsAgro['fuel'] as $row_f) { ?>
						...
						<tr>
							...
							<td>
								<select name="formData[price-currency]">
									<option value="0">-- wybierz --</option>
									<?php foreach($aAddsAgro['country'] as $row_co) { ?>
						...
						<tr>
							...
							<td>
								<select name="formData[gearbox-type-key]">
									<option value="0">-- wybierz --</option>
									<?php foreach($aAddsAgro['gearbox'] as $row_g) { ?>
							...
							<td>
								<select name="formData[colour-key]">
									<option value="0">-- wybierz --</option>
									<?php foreach($aAddsAgro['colour'] as $row_col) { ?>
			...
			<tr>
				<td style="border-top: none;">
					...
					<table style="width: 720px; margin-bottom: 20px;">
						<?php $i=0; foreach($aAddsAgro['extras'] as $row_i) { ?>
						<?php if($i == 0) { ?><tr><?php } ?>
						<?php if(is_int($i/3)) { ?></tr><tr><?php } ?>
							<td style="border-top: 0; width: 33%; vertical-align: top; padding: 5px 0;">
			...
			<tr>
				<td style="border-top: none;">
					...
					<table style="width: 720px; margin-bottom: 20px;">
						<?php $i=0; foreach($aAddsAgro['features'] as $row_e) { ?>
						<?php if($i == 0) { ?><tr><?php } ?>
						<?php if(is_int($i/3)) { ?></tr><tr><?php } ?>
							<td style="border-top: 0; width: 33%; vertical-align: top; padding: 5px 0;">
