		...
		<tr>
			...
			<td colspan="4">
				<select name="formData[type]" class="car_type">
					...
					<option value="MOTORBIKE">Motocykle</option>
					<option value="TRUCK">Ciężarówki</option>
					<option value="CONSTRUCTION" selected="selected">Maszyny budowlane</option>
		...
		<tbody>
				...
				<td style="border-top: 0;">
					<table style="width: 720px; margin-bottom: 15px;">
						...
						<tr>
							...
							<td>
								<select name="formData[make-id]" class="form_make_id">
									<option value="0">-- wybierz --</option>
									<?php foreach($aAddsConst['make'] as $row_ma) { ?>
							...
							<td>
								<select name="formData[model-id]" class="form_model_id">
									<option value="0">-- wybierz --</option>
									<?php foreach($aAddsConst['model'] as $row_mo) { ?>
							...
							<td>
								<input type="text" name="formData[model-name]" value="<?php if(!isset($aData['model-name'])) echo $aCar['car_model']; else echo $aData['model-name']; ?>" />
							</td>
						...
						<tr>
							...
							<td style="vertical-align: top;">
								<select name="formData[version-id]" class="form_version_id">
									<option value="0">-- wybierz --</option>
									<?php foreach($aAddsConst['version'] as $row_ve) { ?>
							...
							<td>
								<select size="15" style="width: 220px;" name="formData[allegro-cat-id]" class="allegro_id">
									...
									<?php foreach($aAddsConst['allegro'] as $row_al) { ?>
						...
						<tr>
							...
							<td>
								<select style="width: 100px;" name="formData[vehicle-category-key]" class="vehicle-category-key">
									<option value="0">-- wybierz --</option>
									<?php foreach($aAddsConst['body'] as $row_bo) { ?>
							...
							<td style="vertical-align: middle; font-size: 12px; padding: 5px 8px; text-align: right; width: 150px;">
								<span style="color: red; font-weight: bold;">Typ</span>:
							</td>
							<td colspan="3">
								<select style="width: 100px;" name="formData[vehicle-type]" class="vehicle-type">
									<option value="0">-- wybierz --</option>
						...
						<tr>	
							...
							<td colspan="5">
								<select name="formData[fuel-type-key]">
									<option value="0">-- wybierz --</option>
									<?php foreach($aAddsConst['fuel'] as $row_f) { ?>
						...
						<tr>
							<td style="text-align: left; height: 80px; padding-top: 10px" colspan="5">
						...
						<tr>
							<td style="vertical-align: middle; font-size: 12px; padding: 5px 8px; text-align: right; width: 150px;">
								<span style="color: #848E92; font-weight: bold;">Model - dodatkowe informacje</span>:
							</td>
							<td>
								<input type="text" style="width: 100px" name="formData[model-name-extension]" value="<?php if(!isset($aData['model-name-extension'])) echo $aCar['car_model']; else echo $aData['model-name-extension']; ?>" />
							</td>
						...
						<tr>
							...
							<td>
								<select name="formData[price-currency]">
									<option value="0">-- wybierz --</option>
									<?php foreach($aAddsConst['country'] as $row_co) { ?>
						...
						<tr>
							...
							<td>
								<select name="formData[gearbox-type-key]">
									<option value="0">-- wybierz --</option>
									<?php foreach($aAddsConst['gearbox'] as $row_g) { ?>
							...
							<td>
								<select name="formData[colour-key]">
									<option value="0">-- wybierz --</option>
									<?php foreach($aAddsConst['colour'] as $row_col) { ?>
			...
			<tr>
				<td style="border-top: none;">
					...
					<table style="width: 720px; margin-bottom: 20px;">
						<?php $i=0; foreach($aAddsConst['extras'] as $row_i) { ?>
						<?php if($i == 0) { ?><tr><?php } ?>
						<?php if(is_int($i/3)) { ?></tr><tr><?php } ?>
							<td style="border-top: 0; width: 33%; vertical-align: top; padding: 5px 0;">
			...
			<tr>
				<td style="border-top: none;">
					...
					<table style="width: 720px; margin-bottom: 20px;">
						<?php $i=0; foreach($aAddsConst['features'] as $row_e) { ?>
						<?php if($i == 0) { ?><tr><?php } ?>
						<?php if(is_int($i/3)) { ?></tr><tr><?php } ?>
							<td style="border-top: 0; width: 33%; vertical-align: top; padding: 5px 0;">
