			...
			<table style="width: 720px; margin-bottom: 20px;">
				...
				<td style="border-top: 0; width: 33%; vertical-align: top; padding: 5px 0;">
				    <?php $checked = false; foreach($row_r['data'] as $row_d) {
					    if($row_d[$row_r['info']['main_column']] == $row_val[$row_r['info']['main_column']])
						$checked = 'checked="checked"';
					    } ?>
				    <div style="float: left;"><input type="checkbox" name=<?php echo $row_r['info']['main_column_id']; ?>_field[]" <?php echo $checked; ?> value="<?php echo $row_val[$row_r['info']['main_column_id']]; ?>" /></div>
				    <div style="float: left; margin-left: 5px; margin-top: 3px; width: 200px;"><?php echo $row_val[$row_r['info']['main_column']]; ?></div>
				</td>
			    ...
			    <?php } ?>
						...
						<table class="handle" style="cursor: move; background-color: #fff;">
							...
							<tr style="background:<?php if(is_int($k/2)) echo '#E9F0F2'; else echo '#F2F2F2'; ?>">
								...
								<td style="width: 130px;"><img style="margin: 0px; width: 120px; height:67px; padding: 5px 0 0 5px;" src="<?php echo $row_r['info'][$row_r['info']['main_column']]['file_miejsce_www'].$atr4.'/'.$row_d['pl'][$row_r['info']['main_column_id']].'_thumb.'.$row_r['info'][$row_r['info']['main_column']]['image_main_roz']; ?>" /></td>
								...
								<?php } else { ?>
								<td style="width: 130px;"><img style="margin: 0px; width: 120px; height:67px; padding: 5px 0 0 5px;" src="<?php echo $row_r['info'][$row_r['info']['main_column']]['file_miejsce_www'].$atr4.'/'.$row_d[$row_r['info']['main_column_id']].'_thumb.'.$row_r['info'][$row_r['info']['main_column']]['image_main_roz']; ?>" /></td>
