...
class WithAndWithoutStars implements StrategyInterface {
	...
	public function query($query, \Sphinx\Search $search)
	{
		...
		$query = '('.StringHelper::addStarsToWords($query, $this->minLenWithStars).')|('.StringHelper::addStarsToWords(StringHelper::breakQueryToAlfaAndDigits($query), $this->minLenWithStars).')';
