...
$root_path = '/admin'; 					//path from webroot, without trailing slash. If your page is located in http://www.example.com/john/, this should be '/john'
...
<head>
  ...
  <link rel="stylesheet" href="/js<?php echo $root_path; ?>/tiny_mce/themes/advanced/skins/default/dialog.css" type="text/css" />
  <script type="text/javascript" src="/js<?php echo $root_path; ?>/tiny_mce/tiny_mce_popup.js"></script>
