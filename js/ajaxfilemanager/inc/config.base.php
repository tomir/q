...
//error_reporting(E_ALL ^ E_NOTICE);
	...
	{
		define('CONFIG_SYS_DEFAULT_PATH', '../zdjecia2007/'); //accept relative path only
		define('CONFIG_SYS_ROOT_PATH', '../zdjecia2007/');	//accept relative path only
	}else{
		define('CONFIG_SYS_DEFAULT_PATH', $_GET['filepath']); //accept relative path only
		define('CONFIG_SYS_ROOT_PATH', $_GET['filepath']);	//accept relative path only
	}
